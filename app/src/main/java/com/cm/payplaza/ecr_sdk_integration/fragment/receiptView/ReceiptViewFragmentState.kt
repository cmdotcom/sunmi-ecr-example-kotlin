...
sealed class ReceiptViewFragmentState: BaseEcrFragmentViewState() {
    ...
    data class SuccessOneReceipt(val receipt: Receipt, val isSuccessful: Boolean): ReceiptViewFragmentState()
    data class SuccessTwoReceipt(val customerReceipt: Receipt, val merchantReceipt: Receipt, val isSuccessful: Boolean): ReceiptViewFragmentState()
    data class MerchantReceiptShowed(val receipt: Receipt, val isSuccessful: Boolean): ReceiptViewFragmentState()
